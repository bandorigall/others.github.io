...
#info-link{
  ...
  border:1.5px solid var(--band-primary);background:transparent;color:var(--band-primary);
  font-family:'M PLUS Rounded 1c',sans-serif;font-size:12px;font-weight:700;white-space:nowrap;
  transition:background var(--dur),color var(--dur),border-color var(--dur);
}
#info-link:hover{background:var(--band-primary);color:#fff}
...
<div id="app">
  ...
  <div id="header">
    ...
    <a id="info-link" href="info.html">게임 정보</a>
